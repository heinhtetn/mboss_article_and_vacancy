...
<div class="preloader">
        ...
        <div class="vertical-centered-box">
            <div class="content">
                ...
                <img src="{{asset('assets/img/M-BOSS-Logo-crop.png')}}" width="58px" alt="">
            </div>
        </div>
...
<header class="header-area2 style-2 two">
        <div class="header-logo">
            <a href="index.html"><img alt="image" class="img-fluid" src="{{asset('assets/img/M-BOSS-Logo-crop.png')}}"
        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none">
                <div class="mobile-logo-wrap">
                    ...
                    <a href="index.html"><img alt="image" src="{{asset('assets/img/M-BOSS-Logo-crop.png')}}" style="width: 30px;height:30px;"></a>
            ...
            <ul class="menu-list fi">
                ...
                <li>
                    <a href="{{route('about',app()->getLocale())}}">{{__('about')}}</a> 
                </li>
                <li>
                    <a href="{{route('blogs',app()->getLocale())}}">{{__('blogs')}}</a> 
                </li>
                <li>
                    <a href="{{route('vacancies',app()->getLocale())}}">{{__('vacancies')}}</a>  
                </li>
                <li>
                    <a href="{{route('faq',app()->getLocale())}}">{{__('faqs')}}</a> 
                </li>
            ...
            <div class="d-lg-none d-block">
                ...
                <div class="header-btn5">
                    <a class="primary-btn3" href="{{asset('assets/img/M BOSS FLYER.pdf')}}" download="M Boss flyer">Download Flyer</a>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            <div class="header-contact d-xl-block d-none">
                <span><img src="{{asset('assets/img/home-6/phone.svg')}}" alt="">For Client Support:</span>
    ...
    @yield('content')
       ...
       <footer class="four en-footer">
        <div class="footer-top en justify-content-center">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-top-content">
                            <div class="footer-logo">
                                <a href="index.html"><img class="img-fluid" src="{{asset('assets/img/M-BOSS-Logo-crop.png')}}"
                            ...
                            <div class="footer-contect">
                                ...
                                <div class="content">
                                    <span>{{__('call')}}</span>
                                    <h6><a class="phone-no" href="tel: 29658718617">{{__('phone')}}</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-lg-4 gy-5 en justify-content-center">
                <div class="col-lg-4 col-sm-6 d-flex">
                    <div class="footer-widget">
                        <div class="footer-contact mb-40">
                            ...
                            <a href="#" class="text-orange">{{__('address-link')}}</a>
                        </div>
                        <div class="footer-contact mb-40">
                            <h4>
                ...
                <div class="col-lg-4 col-sm-6 d-flex justify-content-lg-center">
                    <div class="footer-widget">
                        ...
                        <div class="menu-container text-center">
                            <img src="{{asset('assets/img/M-BOSS-Logo-crop.png')}}" width="150px" height="auto" alt="mboss">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 d-flex justify-content-sm-end">
                    <div class="footer-widget">
                        ...
                        <div class="menu-container">
                            <ul>
                                <li><a href="{{url('/',app()->getLocale())}}" class="text-orange">{{__('home')}}</a></li>
                                <li><a href="{{route('about',app()->getLocale())}}" class="text-orange">{{__('about')}}</a></li>
                                <li><a href="{{route('blogs',app()->getLocale())}}" class="text-orange">{{__('blogs')}}</a></li>
                                <li><a href="{{route('vacancies',app()->getLocale())}}" class="text-orange">{{__('vacancies')}}</a></li>
                                <li><a href="{{route('faq',app()->getLocale())}}" class="text-orange">{{__('faqs')}}</a></li>
                                <li><a href="{{route('contact',app()->getLocale())}}" class="text-orange">{{__('contact')}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-btm">
            <div class="container ">
                <div class="row en justify-content-center">
                    <div class="col-lg-12">
