    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            ->addColumn('action', function($a) {
                ...
                $detail = '<a href=" '.route('admin.articles.show', $a->id).'" class="btn btn-primary" style="margin-right: 10px;">Detail</a>';
                $edit = '<a href=" '.route('admin.articles.edit', $a->id).'" class="btn btn-success" style="margin-right: 10px;">Edit</a>';
